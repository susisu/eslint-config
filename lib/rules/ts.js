...
const possibleProblems = {
  "@typescript-eslint/ban-ts-comment": [ERR, { "ts-expect-error": true }],
...
const suggestions = {
  ...
  "@typescript-eslint/array-type": [ERR, { default: "array-simple", readonly: "array-simple" }],
  ...
  "@typescript-eslint/no-namespace": [ERR, { allowDeclarations: true, allowDefinitionFiles: true }],
  ...
  "@typescript-eslint/no-unused-expressions": [ERR, { enforceForJSX: true }],
