...
const possibleProblems = {
  ...
  "no-unsafe-optional-chaining": [ERR, { disallowArithmeticOperators: true }],
  ...
  "no-use-before-define": [WRN, { functions: false, allowNamedExports: true }],
  "no-useless-backreference": ERR,
  "require-atomic-updates": WRN,
  "use-isnan": [ERR, { enforceForSwitchCase: true, enforceForIndexOf: true }],
  "valid-typeof": ERR,
};
...
const suggestions = {
  ...
  "no-unused-expressions": [ERR, { enforceForJSX: true }],
  ...
  "prefer-arrow-callback": [ERR, { allowNamedFunctions: true, allowUnboundThis: true }],
  "prefer-const": ERR,
  ...
  "prefer-promise-reject-errors": [ERR, { allowEmptyReject: false }],
