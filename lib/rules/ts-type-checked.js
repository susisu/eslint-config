...
const possibleProblems = {
  ...
  "@typescript-eslint/no-unsafe-unary-minus": ERR,
...
const suggestions = {
  ...
  "@typescript-eslint/no-unnecessary-condition": [WRN, { allowConstantLoopConditions: true }],
  ...
  "@typescript-eslint/switch-exhaustiveness-check": [WRN, { requireDefaultForNonUnion: true }],
};
